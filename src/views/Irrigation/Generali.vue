          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <span class="flex gap-2 items-center">
                  <input
                    :disabled="satData.S1019 === undefined"
                    v-model="satData.S1019" type="number" name="toleranza-flow-off">
                  <p>%</p>
                </span>
              </td>
            </tr>
...
<script setup>
  ...
  const satParams = ref({
    fields: 'S1000,S1013,S1014,S1032,S1033,S70,S1012,S1020,S1019,S1007,S1002,S1003,S1005,S1006,S1017,S1018,S1036,S1037,S1021,S1010,S1011,S1008,S1009',
  ...
  function onSubmit() {
    ...
    console.log(postPumpConData.value)
    console.log(postMvConData.value)
    console.log(postSatConData.value)
  }
  const tableData = ref([])
  ...
  //       groupedTableData.value[stazione-1][groupedTableData.value[stazione-1].length] = {stazione: stazione, ev: ev}
  //     }

  //   const tmpTableData = groupedTableData.value.filter((data) => { return data.length !== 0 })
  //   numeroStazioni.value = tmpTableData.length
  // }
</script>
