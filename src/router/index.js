...
import Repeater from '@/views/Irrigation/Repeater.vue'
...
const routes = [
  ...
  { path: '/:lang/dashboard/device-detail/:id/irrigation/configuration/repeater', name: 'Repeater', component: Repeater, props: true, meta: { requiresAuth:true } },
